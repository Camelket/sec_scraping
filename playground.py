...
# TODO: to test new SECU object, invoke an htmlfilingparser, spacyfilingtextsearch
    ...
    base_spans = alias_matcher.get_base_alias_spans(doc)
    extended_spans = alias_matcher.get_references_to_base_alias_spans(doc, base_spans)
    print(f"base_spans: {base_spans}")
    print(f"extended_spans: {extended_spans}")
